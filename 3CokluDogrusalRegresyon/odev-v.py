...
#veri kumesinin eğitim ve test olarak bölünmesi
...
"""
play_ohe=OneHotEncoder(categorical_features='all')
play=play_ohe.fit_transform(play).toarray()
print(play)"""
